<template>
    <div class="page">
        <header>
            <el-input  size="mini" placeholder="名前"       v-model="query.booker" />
            <el-input  size="mini" placeholder="電話番号"    v-model="query.tel" />
            <el-input  size="mini" placeholder="アドレス"    v-model="query.place" />
            <el-input  size="mini" placeholder="職員"       v-model="query.staff" />
            <el-input  size="mini" placeholder="職員の電話"  v-model="query.staff_tel" />
            <el-input  size="mini" placeholder="略称"       v-model="query.short_name" />
        ...
        <el-dialog :visible="dialog.visible" @close="closeForm">
            <el-form ref="form" label-width="140px" :model="dialog.form" :rules="dialog.rules">
                <el-form-item label="名前" prop="booker">
