<template>
    <div class="page">
        <header>
            <el-input  size="mini" placeholder="検索" v-model="query" />
            <el-button size="mini" @click="reLoad" type="primary">検索</el-button>
            <el-button size="mini" @click="clear">クリア</el-button>
            <el-button size="mini" @click="showAddform">新規作成</el-button>
        </header>
        <main>
            <el-table
                border
                ...
                <el-table-column prop="code"      label="略称"    width="100"/>
                <el-table-column label="操作" >
                    <el-button-group slot-scope="{row}">
                        <el-button icon="el-icon-edit"   size="mini" @click="showEdit(row)">改訂</el-button>
                        <el-button icon="el-icon-plus"   size="mini" @click="addPort(row)" v-if="row.pid == 0" type="success">新着</el-button>
                        <el-button icon="el-icon-delete" size="mini" type="danger" @click="del(row)">消去</el-button>
                    </el-button-group>
                </el-table-column>
            </el-table>
        </main>
        <el-dialog :visible="dialog.visible" @close="closeForm">
            <el-form ref="form" label-width="140px" :model="dialog.form" :rules="dialog.rules">
                <el-form-item label="名前" prop="label">
                    <el-input v-model="dialog.form.label" />
                </el-form-item>
                <el-form-item label="略称"  prop="code">
                    <el-input v-model="dialog.form.code" />
                </el-form-item>
            </el-form>
            <el-button-group slot="footer">
                <el-button @click="submit" type="primary">OK</el-button>
                <el-button @click="closeForm">戻る</el-button>
            </el-button-group>
        </el-dialog>
    </div>
</template>
